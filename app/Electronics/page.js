      ...
      <div className=" relative min-w-full min-h-[80vh] ">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <h1 className="text-white text-4xl md:text-5xl font-bold text-center px-4">
            Smart Electronics for a Smarter Life
          </h1>
        </div>
      </div>
      <div className="container flex-col items-center mx-auto gap-5 ">
        <h1 className="text-2xl font-bold text-center pt-20 pb-8">
...
export default ElectronicSectionPage;
